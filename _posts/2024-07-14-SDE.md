...
This gives rise to a useful informal rule in Itô calculus (which you'll see soon) is that $$(dW_t)^2 \approx dt$$ on average, while higher powers like $$(dt)^2$$ or $$dt \cdot dW_t$$ are negligible.
