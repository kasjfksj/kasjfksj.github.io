...
<img src = "alexanderlee.github.io/assets/img/blog/WechatIMG3500.png">Gradient of task 2 is moving away optimal point from Task 1, meaing the loss for Task 1 becomes greater, an example of catastrophic forgetting</img>
...
$$
W = W_0 + AB \text{  where }A\in R^{m\times r}\text{  and }B\in R^{r\times n}\text{.  }Here\text{ }r\ll m\text{  and  }n
$$
...
$$
\Delta W = AB \text{  where  } \Delta W = W - W_0
$$
...
<img src = "alexanderlee.github.io/assets/img/blog/WechatIMG3500.png"></img>
