...
In practice we take one sample $$z \sim q_\phi(z|x)$$ (reparameterised) for the expectation and compute the KL analytically. (For more details check online description of VAE architecture and the loss)
