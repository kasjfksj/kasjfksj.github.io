...
# Achievements
I proposed the Partial ZOD-MC, a coordinate-wise variant that samples subsets of dimensions iteratively, reducing oracle complexity from $$ O(\exp(b)) \to O(\exp(d) \cdot b/d) $$ for decomposable potentials where $$d << b$$.
